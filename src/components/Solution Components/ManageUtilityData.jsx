    ...
    return (
        <section className="px-6 py-12 max-w-7xl mx-auto">
            ...
            <div className="w-full px-2 mt-20 mb-10">
                <div className="flex flex-col items-center lg:flex-row gap-15 ">
                    {/* Left Tabs Section */}
                    ...
                    <div className="flex-1 space-y-5">
                        ...
                        <p className="mt-3 text-gray-700 leading-7 ">Gain timely access to accurate and reliable energy and sustainability information. From utility bill management to time-series data, to the sustainability data that matters to you, get a better understanding of your entire footprint.</p>
